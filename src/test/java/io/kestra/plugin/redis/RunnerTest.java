...
import io.kestra.plugin.redis.json.RedisStackTestSupport;
...
class RunnerTest {
    static {
        // Provide Redis Stack URI to flows via configs.tests.redisStackUri
        System.setProperty("tests.redisStackUri", RedisStackTestSupport.redisUri());
    }
